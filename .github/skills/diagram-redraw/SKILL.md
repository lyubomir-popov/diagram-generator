...
6. **Compute box heights from content (inside-out).** See DIAGRAM.md "Typography" (box height formulas). Key checks: 64px minimum for bordered boxes, no dead space below text, annotation style for standalone labels.
