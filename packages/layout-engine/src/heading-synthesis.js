 ...
 */
import { Frame, Direction, Sizing, Border, Fill, } from './frame-model.js';
import { GRID_GUTTER, ICON_SIZE, INSET } from './tokens.js';
export function deriveContentGap(children, options) {
...
export function findSyntheticBody(frame) {
    return frame.children.find(c => c.id === '__body' || (c.id?.endsWith('__body') ?? false));
}
export function applyHeadingAsChild(frame, heading, options) {
    ...
    const bodyDirection = frame.direction === Direction.HORIZONTAL
...
//# sourceMappingURL=heading-synthesis.js.map