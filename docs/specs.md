...
| 022 Diagram authoring AST | `specs/022-diagram-authoring-ast/` | In progress | Compiler scaffold is landed in `packages/layout-engine/src/diagram-author/`; upcoming slices add edge normalization, layout grammar, defaults, validation, lowering, and exporters after the preview-architecture refactor slices. |
